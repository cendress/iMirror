...
class JournalNotesVC: UIViewController, UITextViewDelegate {
    ...
    private func setupTextViews() {
        ...
        titleTextView.font = UIFont(name: "Roboto-Regular", size: 19)
        ...
        notesTextView.font = UIFont(name: "Roboto-Regular", size: 17)
    ...
    private func styleTextView(_ textView: UITextView) {
        ...
        DispatchQueue.main.async { [weak textView] in
            ...
            tv.layer.shadowPath = UIBezierPath(
                roundedRect: tv.bounds,
                cornerRadius: tv.layer.cornerRadius
            ).cgPath
        }
